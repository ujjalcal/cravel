...
class MainPage(BlogHandler):
  def get(self):
      self.write('Hi this is the Wiki I have been working on!!!! <br>To add content just type in some url - like <b><a href="/mycontent"> ujjalcal.appspot.com/mycontent</a>')
